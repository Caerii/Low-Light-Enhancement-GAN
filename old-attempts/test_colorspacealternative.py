    ...
    for filename in os.listdir(input_folder):
        ...
        if os.path.isfile(input_image_path):
            with Image.open(input_image_path) as image:
                ...
                output_image_path = os.path.join(output_folder, 'grayscale_' + filename)
                grayscale_image.save(output_image_path)

convert_folder_to_grayscale("lol_dataset/low", "lol_converted_dataset/low")
convert_folder_to_grayscale("lol_dataset/high", "lol_converted_dataset/high")
